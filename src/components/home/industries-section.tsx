...
export function IndustriesSection() {
  return (
    <section className="bg-beige/40 py-24 lg:py-32 bg-grain relative">
            ...
            {industries.map((industry, i) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative h-80 overflow-hidden rounded-sm bg-background border border-taupe/20 shadow-sm transition-all duration-700 hover:shadow-2xl hover:border-accent/30 hover:-translate-y-2"
                >
                  <div className="absolute inset-0">
                    <Image
                      ...
                      alt={industry.name}
                      fill
                      className="object-cover opacity-10 grayscale transition-all duration-1000 group-hover:scale-110 group-hover:opacity-20 group-hover:grayscale-0"
                      unoptimized
                    />
